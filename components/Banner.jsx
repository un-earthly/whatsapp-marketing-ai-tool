  ...
  return (
      <div class="container pt-10 mx-auto text-left md:text-center">
          ...
          <div class="relative max-w-4xl mx-auto">
              ...
              <a href="https://wpbox.mobidonia.com/register" class="relative w-full px-12 py-5 mt-10 text-xl font-semibold leading-5 text-center text-white capitalize bg-gray-900 md:w-auto hover:bg-gray-800 focus:outline-none focus:bg-gray-800 md:mx-0" data-rounded="" data-primary="gray-900">
                  Start now
              </a>
          </div>

            ...
            <section class="bg-white">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                        ...
                        <h2 class="mb-4 text-5xl tracking-tight font-semibold text-gray-900">Who is Notch for?
                        </h2>
                        <p class="mb-5 font-light text-gray-500 w-2/3">Notch is covering the buying process from the first demo to the sales-handover, helping you to impress buyers, increase deal win rates, and onboard customers smooth than ever.
